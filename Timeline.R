...
generateGantt(tasks=tasks, hlines=hlines, vlines=vlines, plotTitle="PhD Timeline", fontFamily="Source Sans Pro", date_label_size=13)
#generateGantt(tasks=tasks, hlines=hlines, vlines=vlines, plotTitle="PhD Timeline") #Without Source Sans Font
ggsave("timeline_end.pdf", width=16, height=8, units="in", device=cairo_pdf)
ggsave("timeline_end.png", width=16, height=8, units="in", device="png")
